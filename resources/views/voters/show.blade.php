<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __("Voter Details for Election: $election->name") }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="container mx-auto p-4">
                    <div class="mb-4">
                        ...
                        <p class="mt-1 p-2 w-full border border-gray-300 rounded-md">{{ $voter->name }}</p>
                    </div>
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Phone</label>
                        <p class="mt-1 p-2 w-full border border-gray-300 rounded-md">{{ $voter->phone }}</p>
                    </div>
